...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/25 15:14:20 by cjimenez          #+#    #+#             */
/*   Updated: 2023/10/09 13:52:57 by cjimenez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
User::~User()
{
	log_event::info("User: closing socket for \"" + this->nickname + "\": socket", this->socket);
	close(this->socket);
}
...
void User::removes_modes(std::string mode_string)
{
	std::string::iterator it = mode_string.begin();
	for (; it != mode_string.end(); it++)
	{
